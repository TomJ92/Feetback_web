  ...
  function createDicDatatables(data) {
    ...
    if (data.length) {
      data.map(pacient => {
        ...
        temp["name"] = (
          <>
            <a
              href=""
              onClick={() =>
                history.push("/admin/patient", { pacient: pacient.id, name: pacient.name, lastname: pacient.lastname, email: pacient.email, lastMeetingDate: pacient.lastMeetingDate })
              }
            >
              {" "}
        ...
        temp["lastMeetingDate"] = pacient.lastMeetingDate
        ...
        temp["options"] = (
          <>
            <Button
              onClick={() =>
                history.push("/admin/patientProfile", {
                  patientId: pacient.id,
                  podiatrist: "1",
                  name: pacient.name,
                  lastname: pacient.lastname,
                  lastMeetingDate: pacient.lastMeetingDate,
                  email: pacient.email
                })
              }
            >
